...
const PRICE_TEXT = { en: '$9.99 / month', ps: '9.99$ / میاشت' };
const TRIAL_DAYS = 14;
...
const I18N = {
  ...
  ps: {
    tagline: 'بارکوډ سکن کړئ. عکس، نرخ او موجودي — سملاسي وګورئ.',
    heroSub: 'د هغو دکانونو او ګدامونو لپاره چې کارګرانو ته د رسیدونو لوستل اړین نه وي. یو سکن ټول څه ښیي.',
    startTrial: '14 ورځې وړیا آزموینه پیل کړئ', ownerLogin: 'د مالک ننوتل', workerLogin: 'د کارګر ننوتل',
    feat1t: 'سکن او وګورئ', feat1d: 'ګرځنی هر بارکوډ ته ونیسئ. د توکي عکس، نرخ او موجودي ښکاره کیږي.',
    feat2t: 'هر ګدام', feat2d: 'موجودي ختمه شوې؟ اپلیکیشن ښیي چې کوم بل ګدام یې لري، او یې نرخ.',
    feat3t: 'لوستل ته اړتیا نشته', feat3d: 'لومړی عکسونه او شمیرې. کارګران یوازې د کوډ او پین سره ننوځي.',
    pricingT: 'ساده نرخونه', pricingTrial: '14 ورځې وړیا — کارت ته اړتیا نشته',
    signupT: 'خپل کاروبار جوړ کړئ', loginT: 'د مالک ننوتل',
    email: 'بریښنالیک', password: 'پټنوم', bizName: 'د کاروبار نوم', yourName: 'ستاسو نوم',
    createAccount: 'حساب جوړ کړئ', logIn: 'ننوتل', forgotPw: 'پټنوم مو هیر شوی؟',
    haveAccount: 'حساب مو شته؟ ننوځئ', noAccount: 'نوی یاست؟ خپل کاروبار جوړ کړئ',
    checkEmail: 'خپل بریښنالیک وګورئ او د تایید لینک کېکاږئ، بیا ننوځئ.',
    workerT: 'د کارګر ننوتل', bizCode: 'د کاروبار کوډ', pin: 'پین',
    workerHint: 'له خپل مشر څخه کوډ او خپل پین وغواړئ',
    enter: 'ننوتل', wrongLogin: 'غلط کوډ یا پین',
    scanBtn: 'بارکوډ سکن کړئ', searchPh: 'توکی ولټوئ…', typeBarcode: 'د بارکوډ شمیره ولیکئ',
    products: 'توکي', noProducts: 'تر اوسه توکي نشته. لومړی توکی د اضافه کولو لپاره "مدیریت" پرانیزئ.',
    noProductsWorker: 'تر اوسه توکي نشته. له مالک وغواړئ چې توکي اضافه کړي.',
    navHome: 'کور', navManage: 'مدیریت', scanHint: 'کامره بارکوډ ته ونیسئ',
    camError: 'کامره شتون نلري. تاسو کولی شئ د بارکوډ شمیره ولیکئ.',
    keypadPh: 'شمیره ولیکئ…', productInfo: 'توکی', notFoundTitle: 'ونه موندل شو',
    notFoundMsg: 'دا بارکوډ په سیسټم کې نشته:', addThis: 'دا توکی اضافه کړئ', scanAgain: 'بیا سکن کړئ',
    manage: 'مدیریت', warehouses: 'ګدامونه', workers: 'کارګران', settings: 'تنظیمات',
    addProduct: 'توکی اضافه کړئ', editProduct: 'توکی سم کړئ', takePhoto: 'عکس واخلئ',
    barcode: 'بارکوډ', prodName: 'د توکي نوم', priceStockPerWh: 'د هر ګدام نرخ او موجودي',
    save: 'خوندي کړئ', delete: 'توکی ړنګ کړئ', chooseWh: 'ګدام غوره کړئ', newWhPh: 'د نوي ګدام نوم…',
    inStock: 'شتون لري', lowStock: 'لږ', outStock: 'ختم شوی', noPrice: 'دلته نه پلورل کیږي',
    otherWh: 'نور ګدامونه', price: 'نرخ', stock: 'موجودي',
    saved: 'خوندي شو ✔', needName: 'مهرباني وکړئ نوم ولیکئ', needBarcode: 'مهرباني وکړئ بارکوډ ولیکئ',
    dupBarcode: 'دا بارکوډ مخکې شتون لري', confirmDelete: 'دا توکی ړنګ شي؟',
    confirmDeleteWh: 'دا ګدام ړنګ شي؟', needOneWh: 'تاسو ته لږ تر لږه یو ګدام په کار دی',
    confirmDeleteWorker: 'دا کارګر لرې شي؟',
    addWorker: 'کارګر اضافه کړئ', workerName: 'د کارګر نوم', workerPin: 'پین (4-6 شمیرې)',
    workerCreated: 'کارګر اضافه شو ✔ ورته د کاروبار کوډ + خپل پین ورکړئ',
    yourCode: 'ستاسو د کاروبار کوډ', codeHint: 'کارګران دا کوډ + خپل پین د ننوتلو لپاره کاروي',
    currency: 'د پیسو نښه', logout: 'وتل',
    trialLeft: (d) => `وړیا آزموینه: ${d} ورځې پاتې دي`,
    trialOver: 'ستاسو وړیا آزموینه پای ته رسیدلې',
    subT: 'د ScanStock دوامداره کارولو لپاره ګډون وکړئ',
    subMsg: 'ستاسو 14 ورځنۍ وړیا آزموینه پای ته رسیدلې. د خپلو توکو، ګدامونو او کارګرانو ساتلو لپاره ګډون وکړئ.',
    subBtn: 'همدا اوس ګډون وکړئ', subAfter: 'د تادیې وروسته ستاسو حساب به د 24 ساعتونو دننه فعال شي.',
    subContact: 'د تادیې سیسټم بشپړیږي. د خپل حساب فعالولو لپاره موږ سره اړیکه ونیسئ.',
    active: 'ګډون فعال دی ✔', offline: 'اړیکه نشته — وروستي خوندي شوي معلومات ښودل کیږي',
    loading: 'بارېږي…', errGeneric: 'یوه ستونزه رامنځته شوه. بیا هڅه وکړئ.',
    pwShort: 'پټنوم باید لږ تر لږه 8 توري ولري', pinFormat: 'پین باید 4-6 شمیرې وي',
    uploadingPhoto: 'عکس اپلوډ کیږي…', readOnly: 'یوازې مالک کولی شي توکي بدل کړي',
    importCsv: 'CSV ننویستل', importT: 'له CSV څخه توکي ننویستل',
    importHint: 'کالمونه: barcode, name, warehouse, price, stock — د هر توکي او ګدام لپاره یوه کرښه. د ګدام نومونه باید سمې مطابقت ولري. د ورته بارکوډ + ګدام بیا ننویستل یې تازه کوي.',
    downloadTemplate: 'نمونه ډاونلوډ کړئ', chooseFile: 'د CSV فایل غوره کړئ',
    importPreviewCount: (n) => `${n} کرښې د ننویستلو لپاره چمتو دي`,
    importErrorsCount: (n) => `${n} کرښې پرېښودل شوې`,
    importConfirm: 'ننویستل', importDone: (n) => `${n} کرښې ننویستل شوې ✔`,
    whNotFound: (name) => `ګدام "${name}" ونه موندل شو`,
    invalidPrice: 'ناسم نرخ', invalidStock: 'ناسمه موجودي',
    missingBarcode: 'بارکوډ نشته', missingName: 'نوم نشته', missingWarehouse: 'ګدام نشته',
    noValidRows: 'په دې فایل کې کومه کرښه ونه موندل شوه', csvColumnsMissing: 'CSV باید دا کالمونه ولري: barcode, name, warehouse, price',
    row: 'کرښه',
    sellMode: 'د پلورلو حالت', sellScanHint: 'د پلورلو لپاره سکن کړئ',
    sellNotFound: 'ونه موندل شو — هېڅ ونه پلورل شو',
    sellNoPrice: (name) => `${name} دلته نرخ نلري — هېڅ ونه پلورل شو`,
    soldToast: (qty, name, left) => `${qty}× ${name} وپلورل شو — ${left} پاتې دي`,
    soldOutToast: (qty, name) => `${qty}× ${name} وپلورل شو — ختم شوی`,
  },
};
const LANG_NAMES = { en: 'English', ps: 'پښتو' };
